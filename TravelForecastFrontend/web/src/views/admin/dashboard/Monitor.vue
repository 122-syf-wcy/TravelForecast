...
const systemStatus = ref([
  { label: 'CPU使用率', value: '加载中...', percentage: 0, icon: 'chart' },
  { label: '内存使用率', value: '加载中...', percentage: 0, icon: 'bolt' },
  { label: '磁盘使用率', value: '加载中...', percentage: 0, icon: 'package' },
  { label: '网络带宽', value: '加载中...', percentage: 0, icon: 'map' }
])
