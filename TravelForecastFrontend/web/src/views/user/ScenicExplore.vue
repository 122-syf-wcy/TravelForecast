    ...
    >
      ...
      <div v-if="currentScenic" class="scenic-detail-content">
        ...
        <div class="detail-stats-grid">
          <div class="stat-item">
            <div class="stat-icon time-icon"><SvgIcon name="clock" /></div>
            <div class="stat-info">
          ...
          <div class="stat-item">
            <div class="stat-icon price-icon"><SvgIcon name="ticket" /></div>
            <div class="stat-info">
          ...
          <div class="stat-item">
            <div class="stat-icon duration-icon"><SvgIcon name="clock" /></div>
            <div class="stat-info">
          ...
          <div class="stat-item crowd-stat">
            <div class="stat-icon crowd-icon"><SvgIcon name="users" /></div>
            <div class="stat-info">
        ...
        <div v-if="showReviewSection" class="reviews-section">
          <div class="reviews-header">
            <h3 class="reviews-title">
              <span class="title-icon"><SvgIcon name="star" /></span>
              游客评价
            </h3>
          ...
          <div v-if="reviews.length > 0" class="reviews-list">
            <div v-for="review in reviews" :key="review.id" class="review-item">
              <div class="review-header">
                ...
                >
                  <span class="like-icon"><SvgIcon name="heart" /></span>
          ...
          <div v-else class="empty-reviews">
            <span class="empty-icon"><SvgIcon name="edit" /></span>
            <p>暂无评价，快来抢沙发吧！</p>
          </div>
        </div>
      </div>
    ...
    >
        ...
        <div class="rescue-dialog-header">
          <div class="header-left">
            <div class="header-icon-wrapper">
              ...
              <span class="header-icon"><SvgIcon name="sos" /></span>
            </div>
            <div class="header-text">
      ...
      <div class="rescue-dialog-content">
        ...
        <div class="warning-banner">
          <div class="warning-icon"><SvgIcon name="warning" /></div>
        ...
        <div class="rescue-section">
          <h3 class="section-title">
            <span class="title-icon"><SvgIcon name="clipboard" /></span>
            选择救援类型
          </h3>
          <div class="rescue-type-grid">
            ...
            >
              <span class="type-icon"><SvgIcon :name="type.icon" /></span>
        ...
        <div class="rescue-section">
          <h3 class="section-title">
            <span class="title-icon"><SvgIcon name="siren" /></span>
            紧急程度
          </h3>
          <div class="emergency-level-group">
            ...
            >
              <span class="level-icon level-dot-red"></span>
            ...
            >
              <span class="level-icon level-dot-yellow"></span>
        ...
        <div class="rescue-section">
          <h3 class="section-title">
            <span class="title-icon"><SvgIcon name="phone" /></span>
            联系信息
          </h3>
          <el-form :model="rescueForm" ref="rescueFormRef" :rules="rescueRules" label-position="top" class="rescue-form">
            <div class="form-row">
              <el-form-item label="联系人姓名" prop="contactName" class="form-item-half">
                <el-input v-model="rescueForm.contactName" placeholder="请输入姓名" class="custom-input">
                  <template #prefix>
                    <span class="input-icon"><SvgIcon name="user" /></span>
                  </template>
                </el-input>
              </el-form-item>
              <el-form-item label="联系电话" prop="contactPhone" class="form-item-half">
                <el-input v-model="rescueForm.contactPhone" placeholder="请输入手机号" class="custom-input">
                  <template #prefix>
                    <span class="input-icon"><SvgIcon name="phone" /></span>
                  </template>
                </el-input>
              </el-form-item>
            </div>
            <el-form-item label="当前位置" prop="location">
              <el-input v-model="rescueForm.location" placeholder="请详细描述您的位置，如：景区入口、山顶观景台等" class="custom-input">
                <template #prefix>
                  <span class="input-icon"><SvgIcon name="pin" /></span>
                </template>
              </el-input>
            </el-form-item>
        ...
        <div class="emergency-tip">
          <span class="tip-icon"><SvgIcon name="lightbulb" /></span>
...
// 救援类型选项
const rescueTypes = [
  { value: 'MEDICAL', label: '医疗救助', icon: 'medical' },
  { value: 'LOST', label: '走失寻人', icon: 'search' },
  { value: 'ACCIDENT', label: '事故求助', icon: 'warning' },
  { value: 'OTHER', label: '其他情况', icon: 'phone' }
]
