            ...
            <div class="banner-left">
              ...
              <div class="banner-features">
                <div class="feature-item" @click="router.push('/user/prediction')">
                  <span class="feature-icon"><SvgIcon name="chart" /></span>
                  <span>客流预测</span>
                </div>
                <div class="feature-item" @click="router.push('/user/planning')">
                  <span class="feature-icon"><SvgIcon name="map" /></span>
                  <span>智能规划</span>
                </div>
                <div class="feature-item" @click="router.push('/user/service')">
                  <span class="feature-icon"><SvgIcon name="bolt" /></span>
                  <span>实时服务</span>
                </div>
              </div>
          ...
          <div class="weather-content">
            <div class="weather-header">
              ...
              <div class="weather-icon-wrapper">
                <span class="weather-emoji"><SvgIcon :name="getWeatherIcon()" /></span>
              </div>
            </div>
            <div class="weather-main">
              ...
              <div class="weather-info">
                ...
                <div class="humidity-info">
                  <span class="humidity-icon"><SvgIcon name="droplet" /></span>
            ...
            <div class="flow-stats-left">
              ...
              <div class="flow-stat-item">
                <div class="stat-icon-box purple">
                  <span class="stat-icon"><SvgIcon name="trend-up" /></span>
                </div>
                <div class="stat-info">
