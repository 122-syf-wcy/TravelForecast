...
export JWT_SECRET=<REDACTED_JWT_SECRET>
export OSS_ACCESS_KEY_ID=<REDACTED_OSS_ACCESS_KEY_ID>
export OSS_ACCESS_KEY_SECRET=<REDACTED_OSS_ACCESS_KEY_SECRET>
export WECHAT_APPID=wx9569d09c12f8de06
export WECHAT_APPSECRET=<REDACTED_WECHAT_APPSECRET>
export DASHSCOPE_API_KEY=<REDACTED_DASHSCOPE_API_KEY>
