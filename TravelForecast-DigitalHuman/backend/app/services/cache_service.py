...
PREWARM_QUESTIONS: List[str] = [
    ...
    '【页面引导】用户刚进入"智教黔行"平台的"数据总览"页面。请用2-3句话欢迎用户，说明"智教黔行"是六盘水智慧研学旅游平台，这里汇聚了全市旅游数据概况、热门景点排行和客流趋势。语气亲切，像研学导师迎接学生。',
    '【页面引导】用户刚进入"智教黔行"平台的"景区探索"页面。请用2-3句话介绍：这里有六盘水的3D全景地形图，可以点击地图上的景区标记直接跳转到实时服务查看详情。引导用户点击地图上的景区图标体验。',
    '【页面引导】用户刚进入"智教黔行"平台的"客流预测"页面。请用2-3句话介绍：可以选择景区和日期范围，平台会用AI预测模型分析未来客流趋势，帮助规划最佳出行时间。',
    '【页面引导】用户刚进入"智教黔行"平台的"行程规划"页面。请用2-3句话引导用户：设置出行天数、人数和兴趣偏好，AI会自动生成个性化的六盘水研学路线，还可以让数字人讲解行程。',
    '【页面引导】用户刚进入"智教黔行"平台的"实时服务"页面。请用2-3句话介绍：可以查看当前景区的实时客流、天气、设施信息，还有紧急救援入口，是研学出行的实时保障中心。',

    # ---- 方案二：景区点击讲解 prompt（景区名须与数据库全称一致！） ----
    # 数据库全称版本（前端 spot.name 传过来的就是全称）
    '【景区讲解】你是"智教黔行"平台的AI研学导师"黔小游"。请用生动活泼的语言为研学学生讲解"梅花山风景区"：包括地理位置特征、自然或文化亮点、研学价值。控制在150字以内，结尾抛一个趣味小问题引发思考。',
    '【景区讲解】你是"智教黔行"平台的AI研学导师"黔小游"。请用生动活泼的语言为研学学生讲解"乌蒙大草原"：包括地理位置特征、自然或文化亮点、研学价值。控制在150字以内，结尾抛一个趣味小问题引发思考。',
    '【景区讲解】你是"智教黔行"平台的AI研学导师"黔小游"。请用生动活泼的语言为研学学生讲解"玉舍国家森林公园"：包括地理位置特征、自然或文化亮点、研学价值。控制在150字以内，结尾抛一个趣味小问题引发思考。',
    '【景区讲解】你是"智教黔行"平台的AI研学导师"黔小游"。请用生动活泼的语言为研学学生讲解"水城古镇"：包括地理位置特征、自然或文化亮点、研学价值。控制在150字以内，结尾抛一个趣味小问题引发思考。',
    '【景区讲解】你是"智教黔行"平台的AI研学导师"黔小游"。请用生动活泼的语言为研学学生讲解"明湖国家湿地公园"：包括地理位置特征、自然或文化亮点、研学价值。控制在150字以内，结尾抛一个趣味小问题引发思考。',
